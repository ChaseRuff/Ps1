function DownloadAndRun {
    param (
        [string]$url = "https://raw.githubusercontent.com/ChaseRuff/Ps1/filelist.txt"  # Укажите правильный путь
    )
    ...
    if ($fileDict.ContainsKey([int]$choice)) {
        ...
        $downloadUrl = "https://raw.githubusercontent.com/ChaseRuff/Ps1/$fileToDownload"  # Укажите правильный путь
