...
$txtFiles.GetEnumerator() | ForEach-Object { 
    Write-Host "$($_.Key)"
}

# Запрашиваем у пользователя название файла (без расширения)
$selectedFileName = Read-Host "Введите название текстового файла (без расширения) для загрузки"
